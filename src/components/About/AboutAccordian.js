  ...
  const accordionData = [
    {
      ...
      content: `Full-Stack Software Developer Student - Prime Digital Academy
    Jan 2023 - June 2023
    Minneapolis, MN
            ...
            <div className="accordion-item" key={index}>
              ...
              {activeIndex === index && (
                <div className="accordion-content">
                  <Typography variant="body1" component="div" color="whitesmoke">
                    {accordionItem.content.split('\n').map((paragraph, index) => (
